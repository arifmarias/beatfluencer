        ...
        <div className="bg-gradient-to-r from-indigo-500 to-purple-500 p-6 text-white relative">
          ...
          <div className="flex items-center space-x-6">
            <div className="w-24 h-24 rounded-full overflow-hidden border-4 border-white/20">
              <img 
                src={influencer.profile_image || `https://ui-avatars.com/api/?name=${encodeURIComponent(influencer.name)}&size=200&background=ffffff&color=6366f1`}
                alt={influencer.name}
                className="w-full h-full object-cover"
              />
            </div>
              ...
              <Card className="p-4">
                ...
                <div className="space-y-2 text-sm">
                  <div className="flex justify-between">
                    ...
                    <span className="font-medium">{influencer.experience_years}</span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-gray-600">Campaigns:</span>
                    <span className="font-medium">{influencer.total_campaigns || 0}</span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-gray-600">Account Type:</span>
                    <span className="font-medium capitalize">{influencer.account_type}</span>
                  </div>
                </div>
              </Card>
                ...
                <Card className="p-4 bg-gradient-to-br from-yellow-50 to-orange-50 border-yellow-200">
                  ...
                  <div className="flex flex-wrap gap-2">
                    {influencer.featured_category && (
                      <Badge className="bg-yellow-100 text-yellow-800">Category Featured</Badge>
                    )}
                    {influencer.featured_creators && (
                      <Badge className="bg-yellow-100 text-yellow-800">Creator Featured</Badge>
                    )}
                  </div>
                </Card>
              )}
            ...
            <div className="space-y-6">
              ...
              {influencer.bio && (
                <Card className="p-4">
                  ...
                  <p className="text-gray-700 text-sm leading-relaxed">{influencer.bio}</p>
                </Card>
              )}
              ...
              {influencer.categories && influencer.categories.length > 0 && (
                <Card className="p-4">
                  <h3 className="font-semibold text-gray-900 mb-3">Content Categories</h3>
                  <div className="flex flex-wrap gap-2">
              ...
              {influencer.industries_worked && influencer.industries_worked.length > 0 && (
                <Card className="p-4">
                  <h3 className="font-semibold text-gray-900 mb-3">Industries Worked</h3>
                  <div className="flex flex-wrap gap-2">
              ...
              {influencer.affiliated_brands && influencer.affiliated_brands.length > 0 && (
                <Card className="p-4">
                  <h3 className="font-semibold text-gray-900 mb-3">Affiliated Brands</h3>
                  <div className="flex flex-wrap gap-2">
                    ...
                    {influencer.social_media_accounts.map((account, index) => (
                      <div key={index} className="bg-gray-50 rounded-lg p-3">
                        ...
                        <div className="text-xs text-gray-600">
                          ...
                          {account.cpv > 0 && <p>CPV: {formatCurrency(account.cpv)}</p>}
                        </div>
                      </div>
                    ))}
                  </div>
                ...
                <div className="space-y-2 text-sm">
                  ...
                  {influencer.address && (
                    <div className="flex items-start space-x-2">
                      ...
                      <span className="text-gray-900">{influencer.address}</span>
                    </div>
                  )}
                </div>
              </Card>
